...
namespace ShelterVault.Services
{
    ...
    {
        readonly IKeyDerivationManager _keyDerivationManager;

        public EncryptionService(IKeyDerivationManager keyDerivationManager)
        {
        ...
        {
            return _keyDerivationManager.DeriveKey(password, salt);
        }
    }
}
